...
export function ServerOperators({ server }: ServerOperatorsProps) {
  ...
  function refreshEntries() {
    invoke("list_operator_entries", { serverId: server.server.server_id }).then(
      (ops) => {
    ...
    <div className="flex-1 min-h-120 max-h-120 bg-bg-2 flex flex-col">
      <div className="relative min-h-120 max-h-120 p-3 overflow-y-scroll pb-10">
        ...
        <div className="mb-4">
          <SettingContainer
            name="Add Operator"
            description="Add a player as an operator."
          >
